...
export function MyWallet() {
  ...
  const { walletTypedata, statusCode, withdrawRequestValue } = useSelector(
    (state) => state.wallet
  );
  ...
  useEffect(() => {
    setLoading(true);
    dispatch(walletData()).finally(() => setLoading(false));
      ...
      <View style={styles.rightSection}>
        ...
        <Text
          style={[
            ...
            {
              color:
                item.status === "pending" ? appColors.red : appColors.price,
            },
          ]}
        >
