...
export function Ride() {
  ...
  const { currSymbol, currValue, textRtlStyle, viewRtlStyle, isDark } = useValues();
      ...
      <View style={styles.greenSection}>
        ...
        <View style={[styles.bottomView, { backgroundColor: colors.card }]}>
          ...
          >
            ...
            >
              <Text style={[styles.value, { color: isDark ? appColors.white : appColors.primaryFont }]}>-10</Text>
            </TouchableOpacity>
          ...
          <View style={styles.button}>
            <Button
              ...
              title={`${translateData.acceptFareon}${currSymbol}${currValue * value}`}
